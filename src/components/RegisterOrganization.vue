      ...
      <div class="col-lg-6 col-md-8 col-sm-12 col-10 shadow p-3">
        ...
        <form>
          ...
          <div class="form-group text-left">
            ...
            <sub
              class="text-danger"
              v-if="$v.org.email.$error && !$v.org.email.email"
            >
              Not a valid email
            </sub>
          </div>
            ...
            <div class="col">
              <div class="form-group text-left">
                ...
                <input
                  class="form-control"
                  type="text"
                  placeholder="3407838753"
                  v-model.trim="org.phone"
                  @input="delayTouch($v.org.phone)"
                />
                <sub
                  class="text-danger text-left"
                  v-if="$v.org.phone.$error && !$v.org.phone.required"
                >
                  Field is required
                </sub>
                <sub
                  ...
                  v-if="
                    $v.org.phone.$error &&
                    (!$v.org.phone.minLength || !$v.org.phone.maxLength)
                  "
                >
                  Not a valid phone
                </sub>
          ...
          <div class="form-group text-left">
            ...
            <input
              class="form-control"
              type="text"
              placeholder="street-250 Area 12 karachi"
              v-model.trim="$v.org.address.$model"
            />
            <sub
              class="text-danger text-left"
              v-if="$v.org.address.$error && !$v.org.address.required"
            >
              Field is required
            </sub>
          </div>
